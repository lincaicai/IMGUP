...
import com.prongbang.convert.ImageManipulation;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String HOST_SERVICE = "http://172.16.1.39:8080/spring-service/service";
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * Choose File Dialog
         */
        choseFile = (Button) findViewById(R.id.choose_file);
            ...
            case R.id.btnUpload:
                ...
                if (!pathFile.getText().equals("") && pathFile.getText() != null) {
                    ...
                    try {
                        ...
                        properties.setImageString(ImageManipulation.encodeImage(imageByte));
